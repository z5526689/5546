...
then `new_delta` is:
'''
utils.pprint(new_delta, msg, pretty = False)

utils.pprint(new_delta.seconds,"ner_delta.seconds")
...
delta  = dt.timedelta(hour = 12)
urils.pprint(delta,"delta")
...
msg =f"I have been alive for {secs:,.0f}"
utils . pprint (msg)
